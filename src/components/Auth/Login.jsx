          ...
          <div className="authentication-inner">
            ...
            <div className="card">
              <div className="card-body">
                ...
                {/* /Logo */}
                <h4 className="mb-2 text-center">Welcome to Back! 👋</h4>
                <p className="mb-4">Please sign-in to your account and start the adventure</p>
                <form id="formAuthentication" className="mb-3" onSubmit={userLogin}>
                  <div className="mb-3">
                    <label htmlFor="email" className="form-label">Email or Username</label>
                    <input type="text" className={login.email === " " && input === true
                      ? "form-control border border-danger"
                      : "form-control"} id="email" name="email" placeholder="Enter your email or username" onChange={inputHandler} autofocus />
                  </div>
                  ...
                  <div className="mb-3">
                    <button className="btn btn-primary d-grid w-100" type="submit"> {loading === true ? "Loading..." : "Sign In"}</button>
                  </div>
                </form>
